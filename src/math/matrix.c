...
static void _matrix_rotate_pane(float* a, float deg, _axis_e axis)
{
    float t[] = MATH_IDENTITY_MATRIX_4x4;
...
{
    _matrix_rotate_pane(a, deg, AXIS_X);
}


void math_matrix_rotate_y(float* a, float deg)
{
    _matrix_rotate_pane(a, deg, AXIS_Y);
}


void math_matrix_rotate_z(float* a, float deg)
{
    _matrix_rotate_pane(a, deg, AXIS_Z);
}
